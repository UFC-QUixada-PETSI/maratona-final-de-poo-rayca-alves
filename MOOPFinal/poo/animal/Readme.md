...
![cover](../../.tko/cache/poo/base/animal/cover.jpg)
...
![_](../../.tko/cache/poo/base/animal/diagrama.png)

- Na seção de [Cheat](#cheat) ou no vídeo abaixo, você pode conferir as respostas dessa atividade.

[![youtube icon](../../.tko/cache/poo/base/animal/../yousolver.png)](https://youtu.be/QZfjLVrk7p8)
...
<!-- links .cache/draft -->
- cpp
  - [shell.cpp](../../.tko/cache/poo/base/animal/.cache/draft/cpp/shell.cpp)
- java
  - [Shell.java](../../.tko/cache/poo/base/animal/.cache/draft/java/Shell.java)
- ts
  - [shell.ts](../../.tko/cache/poo/base/animal/.cache/draft/ts/shell.ts)
<!-- links -->
...
<!-- links .cache/cheat -->
- cpp
  - [shell.cpp](../../.tko/cache/poo/base/animal/.cache/cheat/cpp/shell.cpp)
- java
  - [Shell.java](../../.tko/cache/poo/base/animal/.cache/cheat/java/Shell.java)
- ts
  - [shell.ts](../../.tko/cache/poo/base/animal/.cache/cheat/ts/shell.ts)
<!-- links -->
